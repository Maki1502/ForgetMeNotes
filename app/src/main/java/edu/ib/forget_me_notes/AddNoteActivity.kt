...
//            TextUtils.isEmpty(light_txt.text.toString()) -> Toast.makeText(this, "Add light level", Toast.LENGTH_LONG)
//            TextUtils.isEmpty(water_txt.text.toString()) -> Toast.makeText(this, "Add water level", Toast.LENGTH_LONG)
//            TextUtils.isEmpty(ground_txt.text.toString()) -> Toast.makeText(this, "Add ground type", Toast.LENGTH_LONG)

//            TextUtils.isEmpty(plant_nick.text.toString()) -> Toast.makeText(this, "Add plant nick", Toast.LENGTH_LONG)

            TextUtils.isEmpty(plant_name.text.toString()) -> Toast.makeText(this, "Add plant name", Toast.LENGTH_LONG)
//            TextUtils.isEmpty(plant_info.text.toString()) -> Toast.makeText(this, "Add info about plant", Toast.LENGTH_LONG)
                ...
                uploadTask.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
                    ...
                    if (task.isSuccessful) {
                        ...
                        noteMap["name"] = plant_name.text.toString().lowercase()
                        noteMap["nick"] = plant_nick.text.toString().lowercase()
                        noteMap["info"] = plant_info.text.toString().lowercase()
